...
CREATE TABLE PessoaFisica(idPessoaFisica INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT, 
					cpf CHAR(11),
					idCliente integer,
					FOREIGN KEY(idCliente) REFERENCES Cliente(idCliente) ON DELETE RESTRICT);

CREATE TABLE PessoaJuridica(idPessoaJuridica INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT, 
					cnpj CHAR(15), 
					ie CHAR(20),
					idCliente integer,
					FOREIGN KEY(idCliente) REFERENCES Cliente(idCliente) ON DELETE RESTRICT);
