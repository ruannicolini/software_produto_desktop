 ...
 * @author Ruan
 */
public class JanelaRelComissaoDialog extends javax.swing.JDialog {
    Controlador control;
    /**
     * Creates new form JanelaRelComissaoDialog
     */
    public JanelaRelComissaoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Mês/Ano"));

        cmbMes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Janeiro", "Fevereiro", "Maio", "Abril", "Março", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            lista = control.pesquisarPedidos(null, 3, cmbMes.getSelectedItem().toString(), jtfAno.getText() );
        ...
        try{
            ...
            InputStream rel = getClass().getResourceAsStream("../relatorios/RelComissao.jasper");

            // PASSO 2 - Criar parâmetros de Pesquisa 
            Map parametros = new HashMap();
            // Imagem 
            ImageIcon gto = new ImageIcon(getClass().getResource("../relatorios/leaf_banner_gray.png"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaRelComissaoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JanelaRelComissaoDialog dialog = new JanelaRelComissaoDialog(new javax.swing.JFrame(), true);
